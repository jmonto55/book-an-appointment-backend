  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new House" do
        expect {
          post houses_url, params: { house: valid_attributes }
        }.to change(House, :count).by(1)
      end

      it "redirects to the created house" do
        post houses_url, params: { house: valid_attributes }
        expect(response).to redirect_to(house_url(House.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new House" do
        expect {
          post houses_url, params: { house: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested house" do
        house = House.create! valid_attributes
        patch house_url(house), params: { house: new_attributes }
        house.reload
      ...
      it "redirects to the house" do
        ...
        patch house_url(house), params: { house: new_attributes }
        house.reload
        expect(response).to redirect_to(house_url(house))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        house = House.create! valid_attributes
        patch house_url(house), params: { house: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
